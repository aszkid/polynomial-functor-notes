...
More intuitively; the pullback is the `most general way' to complete a pair of morphisms into a commutative square.

The characteristic function $p:E\to B$ (characteristic in the sense that it defines our polynomial) induces a functor $p^*:(\catset\downarrow B)\to(\catset\downarrow E)$ sending maps $f:Y\to B$ to the pullback
